...
TERM = (
    'electrosynthesis[tiab] OR electroorganic[tiab] OR '
    '"organic electrochemistry"[tiab] OR "anodic oxidation"[tiab] OR '
    '"paired electrolysis"[tiab] OR electrooxidative[tiab] OR '
    'electroreductive[tiab]'
)
